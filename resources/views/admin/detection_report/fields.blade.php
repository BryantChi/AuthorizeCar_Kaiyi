...
<div class="col-md-6">
    ...
    <div class="form-group">
        {!! Form::label('reports_reporter', '報告原有人:') !!}
        {!! Form::text('reports_reporter', null, ['class' => 'form-control']) !!}
    </div>
    <div class="form-group">
        <label class="font-weight-bold" for="reports_car_brand">廠牌</label>
        <select class="form-control custom-select2 bg-white2 @error('reports_car_brand') is-invalid @enderror"
    ...
    <div class="form-group">
        ...
        <select class="form-control custom-select2 bg-white2 @error('reports_regulations') is-invalid @enderror"
...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        {!! Form::text('reports_reply', 0, ['class' => 'form-control']) !!}
    </div>
    <div class="form-group d-none">
        {!! Form::label('reports_note', '說明:') !!}
        {!! Form::text('reports_note', 0, ['class' => 'form-control']) !!}
    </div>
    <div class="form-group">
        <label class="font-weight-bold" for="reports_authorize_status">授權狀態</label>
        <select class="form-control custom-select2 bg-white2 @error('reports_authorize_status') is-invalid @enderror"
